...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/1WofXKQNJurvPfM1NglTMM"
    df_happy = process_playlist(playlist_url, "happy")
    df_happy.to_csv("happy_playlist_data2.csv", index=False)
    print(df_happy.head())