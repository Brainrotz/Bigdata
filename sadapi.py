...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/4ABk0ergIcPkfHtXEzTSSi"
    df_sad = process_playlist(playlist_url, "sad")
    df_sad.to_csv("sad_playlist_data.csv", index=False)
    print(df_sad.head())