...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/3xD1YeTBAjYaYpJK2fmYu6"
    df_premaderomantic = process_playlist(playlist_url, "romantic")
    df_premaderomantic.to_csv("premaderomatic_playlist_data.csv", index=False)
    print(df_premaderomantic.head())