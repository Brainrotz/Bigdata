...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/3MrT4qHZmZ6ohcCxyxwyLk"
    df_angry = process_playlist(playlist_url, "angry")
    df_angry.to_csv("angry_playlist_data.csv", index=False)
    print(df_angry.head())