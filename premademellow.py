...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/6F52KYYVT9BlK6VY9zrPuC"
    df_premademellow = process_playlist(playlist_url, "mellow")
    df_premademellow.to_csv("premademellow_playlist_data.csv", index=False)
    print(df_premademellow.head())