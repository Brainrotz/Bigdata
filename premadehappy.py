...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/0ElgLMPmY2L6bi6bknp6e0"
    df_premadehappy = process_playlist(playlist_url, "happy")
    df_premadehappy.to_csv("premadehappy_playlist_data.csv", index=False)
    print(df_premadehappy.head())