...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/54oNlhRflcj7U1QRHeATWT"
    df_premadeangry = process_playlist(playlist_url, "angry")
    df_premadeangry.to_csv("premadeangry_playlist_data.csv", index=False)
    print(df_premadeangry.head())