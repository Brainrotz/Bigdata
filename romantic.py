...
if __name__ == "__main__":
    playlist_url = "https://open.spotify.com/playlist/3ZoPwa18YML4DM8hIIx0vN"
    df_romantic = process_playlist(playlist_url, "romantic")
    df_romantic.to_csv("romantic_playlist_data.csv", index=False)
    print(df_romantic.head())